...
<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('regn_no')); ?>:</b>
	<?php echo CHtml::encode($data->regn_no); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('rc_no')); ?>:</b>
	<?php echo CHtml::encode($data->rc_no); ?>
	<br />
