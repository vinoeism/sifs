...
<?php if (isset($model->approved_by)) { ?>
    ...
    //		'comments',
                    ...
                    array(
                      'name'=> 'tax_1',
                      'value' => 'isset($data->tax_1)?Tax::model()->findByPk($data->tax_1)->tax_name:"NA"',
                    ),
                    'tax_1_amount',
                    array(
                      'name'=> 'tax_2',
                      'value' => 'isset($data->tax_2)?Tax::model()->findByPk($data->tax_2)->tax_name:"NA"',
                    ),
                    'tax_2_amount',
                    array(
                      'name'=> 'tax_3',
                      'value' => 'isset($data->tax_3)?Tax::model()->findByPk($data->tax_3)->tax_name:"NA"',
                    ),
                    'tax_3_amount',
                    array(
                      'name'=> 'tax_4',
                      'value' => 'isset($data->tax_4)?Tax::model()->findByPk($data->tax_4)->tax_name:"NA"',
                    ),
                    'tax_4_amount',
    //		'isActive',
    //		'pass_id',
